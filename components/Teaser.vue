<template>
  <div v-editable="blok" class="container mx-auto px-4">
    <div class="flex justify-between py-16 sm:py-24">
      ...
      >
        ...
        <h2 class="text-lg font-medium mb-6">
          You have successfully setup a Nuxt.js project with Storyblok!
        </h2>
        <div class="flex flex-col sm:block py-4">
          <a
            target="_blank"
            href="https://www.storyblok.com/tc/nuxtjs"
